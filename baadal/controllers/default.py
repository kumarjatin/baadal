...
def request_vm_template():
    ...
    form_fields = ['vmname','config','HDD','templateid','purpose']
    form_labels = {'vmname':'Name of VM','config':'Configuration','HDD':'Optional Additional Harddisk(GB)','templateid':'Template Image','purpose':'Purpose of this VM'}
    ##form_fields = ['vmname','config','HDD','templateid','purpose','rr','expire_date']
    ##form_labels = {'vmname':'Name of VM','config':'Configuration','HDD':'Optional Additional Harddisk(GB)','templateid':'Template Image','purpose':'Purpose of this VM','rr':'Failover Enabled','expire_date':'Timeline till when VM is required'}
...
def index():
    #user='syamprasad'
    #ret=  db.executesql('SELECT username FROM auth_user where username=\''+user+'\';')
    #print ret
    #if ret:
    #  print("List is not empty.True")
    #else:
    #  print("List is empty.False")
    if auth.user!=None:
