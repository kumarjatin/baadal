...
Normal_pkg_lst=(ssh zip unzip tar openssh-server build-essential python2.7:python2.5 python-dev apache2 libapache2-mod-wsgi postfix wget libapache2-mod-gnutls apache2.2-common python-matplotlib python-reportlab mercurial libvirt-bin python-libvirt sshpass)
